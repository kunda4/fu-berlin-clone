      ...
      <div className='lg:grid grid-cols-3 gap-8 lg:py-16 py-8 items-center'>
        <div className='grid col-start-1 col-span-2 relative overflow-hidden group'>
          ...
          <div className='relative'>
            <p className='bg-[#EEEEEE] py-3 px-3 text-xl group-hover:bg-[#CCCCCC]'>Measures Taken against Antisemitism, Racism, and Discrimination: Counseling and Advice Services, Events, University Communication Regarding the Conflict in the Middle East</p>
